...
export const translations = {
  ...
  menu_access: { lo: 'ສິດເຂົ້າເມນູ', en: 'Menu Access' },
  menu_access_hint: { lo: 'ເລືອກເມນູທີ່ຜູ້ໃຊ້ນີ້ເຂົ້າໄດ້ (ຖ້າວ່າງ = ຄ່າເລີ່ມຕົ້ນ)', en: 'Pick the menus this user can access (empty = default set)' },
  created_by: { lo: 'ຜູ້ບັນທຶກ', en: 'Recorded by' },
  ...
  exchange_rates_hint: { lo: '1 ໜ່ວຍ = ? ກີບ (ຕັ້ງຄັ້ງດຽວ ໃຊ້ທຸກເມນູ)', en: 'LAK per 1 unit (set once, used everywhere)' },
